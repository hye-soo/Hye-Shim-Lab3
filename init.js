...
function AskFunction() {
  ...
  readline.question("Here is"+" "+myName + " and "+friend+" and "+enemy+" "+'story altogether for you (type "exit" to quit): ', input => {
    ...
    if (chatCount ===0) {
      ...
      console.log("Did you like it?! here is more.")
    }
    if (chatCount ===1) {
...
function AskName() {
  ...
  readline.question('Hello, write your hero name (type "exit" to quit): ', input => 
    readline.question('Hello, write your friend name (type "exit" to quit): ', input2 =>
      readline.question('Hello, write your enemey name (type "exit" to quit): ', input3 =>
